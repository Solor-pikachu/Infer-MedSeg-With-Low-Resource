        ...
        while self.epoch < self.max_num_epochs:
            ...
            if self.use_progress_bar:
                with trange(self.num_batches_per_epoch) as tbar:
                    for b in tbar:
                        ...
                        l = self.run_iteration(self.tr_gen,self.tr_unlabel ,True)
            ...
            with torch.no_grad():
                ...
                for b in range(self.num_val_batches_per_epoch):
                    l = self.run_iteration(self.val_gen,self.tr_unlabel,False, True)
                    val_losses.append(l)
                ...
                if self.also_val_in_tr_mode:
                    ...
                    val_losses = []
                    for b in range(self.num_val_batches_per_epoch):
                        l = self.run_iteration(self.val_gen,self.tr_unlabel,False)
                        val_losses.append(l)
