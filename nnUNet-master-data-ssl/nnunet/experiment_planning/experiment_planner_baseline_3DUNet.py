...
class ExperimentPlanner(object):
    ...
    def plan_experiment(self):
        ...
        self.plans_per_stage = {0: {'batch_size': 2,
                 'num_pool_per_axis': [3, 4, 4],
                 'patch_size': np.array([ 96, 128, 128]),
                 'median_patient_size_in_voxels': np.array([141, 216, 255]),
                 'current_spacing': np.array([2.5, 1.5 , 1.5]),
                ...
                1: {'batch_size': 2,
                 ...
                 'median_patient_size_in_voxels': np.array([272, 416, 491]),
                 'current_spacing': np.array([1.        , 0.77929699, 0.77929699]),
                 'original_spacing': np.array([1.        , 0.77929699, 0.77929699]),
